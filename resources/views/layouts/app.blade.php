...
<body class="antialiased">
    <div class="flex h-screen overflow-hidden">
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center space-x-2 rtl:space-x-reverse ml-auto"> {{-- Use ml-auto to push to right for RTL --}}
                        <button id="user-menu-button-mobile"
                            class="p-1 text-gray-500 rounded-full hover:bg-gray-100 focus:outline-none block">
                ...
                @isset($header)
                    <div class="mb-6">
                        ...
                        <div class="flex items-center mt-2 text-sm text-gray-500">
                            ...
                            <svg class="w-4 h-4 mx-2 rtl:rotate-180" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
        ...
        <nav class="mobile-nav">
            <a href="{{ route('student_groups') }}"
                class="mobile-nav-item {{ request()->routeIs('student_groups') ? 'active' : '' }}">
            ...
            <a href="{{ route('tasks.index') }}"
                class="mobile-nav-item {{ request()->routeIs('tasks.*') || request()->routeIs('student-tasks.*') ? 'active' : '' }}">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('attendances.index') }}"
                class="mobile-nav-item {{ request()->routeIs('attendances.*') ? 'active' : '' }}">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('tasks.evaluate.index') }}"
                class="mobile-nav-item {{ request()->routeIs('tasks.evaluate.*') ? 'active' : '' }}">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 12.75l3 3m0 0l3-3m-3 3v2.25M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke-linecap="round"
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.addEventListener('click', function(event) {
                    ...
                    if (userMenu && !userMenu.classList.contains('hidden')) {
                        ...
                        const isClickOnMobileButton = userMenuButtonMobile && userMenuButtonMobile.contains(
                            event.target);
