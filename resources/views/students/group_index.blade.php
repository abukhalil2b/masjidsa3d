            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-gray-700 mt-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.students.index', $group->id) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-bold text-xs text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-25 transition ease-in-out duration-150">
                        عرض الطلاب
                        </a>
                    </div>
                </div>
