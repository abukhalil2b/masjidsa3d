        ...
        <table class="w-full table-auto border rounded">
            <thead class="bg-gray-100 text-right">
                <tr>
                    ...
                    <th class="px-4 py-2">عدد الحضور</th>
                    <th class="px-4 py-2">التاريخ</th>
                    <th class="px-4 py-2">الحضور</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($attendances as $attendance)
                    <tr class="border-b">
                        <td class="px-4 py-2">{{ $attendance->title }}</td>
                        <td class="px-4 py-2">{{ $attendance->students_count }}</td>
                        <td class="px-4 py-2">{{ $attendance->created_at->translatedFormat('Y/m/d h:i A') }}</td>
                        <td>
